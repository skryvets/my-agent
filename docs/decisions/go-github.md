...
**A:** [github.com/google/go-github/v92](https://pkg.go.dev/github.com/google/go-github/v92/github) `v92.0.0`, the latest release on 2026-09-21. The move from `v89` changed the type `PullRequests.Create` takes from `NewPullRequest` to `CreatePullRequest`, and nothing else this client calls. The module brings `github.com/google/go-querystring` as an indirect dependency.
...
**Docs:** https://raw.githubusercontent.com/google/go-github/v92.0.0/github/github.go (`api20221128`, `NewClient`)

## The two calls
**Q:** Which methods replace the hand-rolled paths?
**A:** `Repositories.Get` for the default branch, `PullRequests.Create` with `CreatePullRequest` for the pull request. The web address is `PullRequest.GetHTMLURL`. An empty default branch is still an error, as before.
**Docs:** https://docs.github.com/rest/repos/repos?apiVersion=2022-11-28#get-a-repository and https://docs.github.com/rest/pulls/pulls?apiVersion=2022-11-28#create-a-pull-request, as cited on the methods in https://raw.githubusercontent.com/google/go-github/v92.0.0/github/repos.go and https://raw.githubusercontent.com/google/go-github/v92.0.0/github/pulls.go
...
**Docs:** https://raw.githubusercontent.com/google/go-github/v92.0.0/github/github.go (`WithURLs`, `WithEnterpriseURLs`) and https://raw.githubusercontent.com/google/go-github/v92.0.0/github/url.go (`parseURL`)
...
**Docs:** https://raw.githubusercontent.com/google/go-github/v92.0.0/github/github.go (`CheckResponse`, `RateLimitError`, `checkRateLimitBeforeDo`)
...
**Docs:** https://raw.githubusercontent.com/google/go-github/v92.0.0/github/github.go (`mediaTypeV3`, `NewRequest`) and https://raw.githubusercontent.com/google/go-github/v92.0.0/github/pulls.go (`Create`)
